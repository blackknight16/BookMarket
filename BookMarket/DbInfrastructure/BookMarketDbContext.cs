...
namespace BookMarket.DbInfrastructure
{
    public class BookMarketDbContext : DbContext
    {
        ...
        public ObjectResult<Int32?> AddAuthor (string lastName, string firstName)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext
                .ExecuteFunction<Int32?>("AddAuthor", lastNameParameter, firstNameParameter);
        }

        public ObjectResult<Int32?> AddBasket(decimal totalAmount, decimal deliveryCost)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext
                .ExecuteFunction<Int32?>("AddBasket", totalAmountParameter, deliveryCostParameter);
        }

        public ObjectResult<Int32?> AddBasketItem(decimal amount, decimal itemCount, Int32 bookVariableInfoId, Int32? basketId, Int32? paymentId)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext
                .ExecuteFunction<Int32?>("AddBasketItem", amountParameter, 
                itemCountParameter, bookVariableInfoParameter, basketIdParameter, 
                paymentIdParameter);
        }

        public ObjectResult<Int32?> AddBook(string name, Int32 year, Int32 pageCount, 
            string imageName, string description, Int32 languageId)
        {
                ...
                return ((IObjectContextAdapter)this).ObjectContext
                    .ExecuteFunction<Int32?>("AddBook", nameParameter, yearParameter,
        ...
        public ObjectResult<Int32?> AddBookTag(string name, Int32 bookTypeId)
        {
            var nameParameter = name != null ?
                new ObjectParameter("Name", name) :
                new ObjectParameter("Name", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext
                .ExecuteFunction<Int32?>("AddBookTag", nameParameter,
                bookTypeIdParameter);
        }
        ...
        public ObjectResult<Int32?> AddBookVariableInfo(Int32 id, 
            Int32 productCount, decimal price)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext
                .ExecuteFunction<Int32?>("AddBookVariableInfo", idParameter, 
                productCountParameter, priceParameter);
        }

        public ObjectResult<Int32?> AddCity(string name)
        {
            var nameParameter = name != null ?
                new ObjectParameter("Name", name) :
                new ObjectParameter("Name", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext
                .ExecuteFunction<Int32?>("AddCity", nameParameter);
        }

        public ObjectResult<Int32?> AddIndividual(Int32 basketId, string lastName,
            string firstName, string middleName)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext
                .ExecuteFunction<Int32?>("AddIndividual", basketIdParameter,
                lastNameParameter, firstNameParameter, middleNameParameter);
        }

        public ObjectResult<Int32?> AddLanguage(string name)
        {
            var nameParameter = name != null ?
                new ObjectParameter("Name", name) :
                new ObjectParameter("Name", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext
                .ExecuteFunction<Int32?>("AddLanguage", nameParameter);
        }

        public ObjectResult<Int32?> AddPayment(Int32 w1PaymentId, bool isPayed, 
            Int32 shopId, Int32 individualId)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext
                .ExecuteFunction<Int32?>("AddPayment", w1PaymentIdParameter,
                isPayedParameter, shopIdParameter, individualIdParameter);
        }

        public ObjectResult<Int32?> AddPublisher(string name)
        {
            var nameParameter = name != null ?
                new ObjectParameter("Name", name) :
                new ObjectParameter("Name", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext
                .ExecuteFunction<Int32?>("AddPublisher", nameParameter);
        }
        ...
        public ObjectResult<Int32?> AddW1Payment(//Int32 wmi_payment_no, 
            ...
            byte[] wmi_signature)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext
                .ExecuteFunction<Int32?>("AddW1Payment", //wmi_payment_noParameter,
        ...
        public ObjectResult<Book> GetAllBooksByTagId(Int32 tagId)
        {
