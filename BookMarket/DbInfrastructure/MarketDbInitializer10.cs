        ...
        : CreateDatabaseIfNotExists<BookMarketDbContext>
    {
        public override void InitializeDatabase(BookMarketDbContext dbContext)
        {
            ...
            if (MarketDbInitializer.DB_WAS_NOT_EXIST)// || _dbCounter == 0)
            {
                ...
                "declare @retorno int " +
                "INSERT INTO [dbo].[Authors]([LastName], [FirstName]) VALUES(" +
                "(@LastName), (@FirstName)) " +
                "select @retorno;");
                ...
                "declare @retorno int " +
                "INSERT INTO [dbo].[Baskets]([TotalAmount], [DeliveryCost]) VALUES(" +
                ...
                "declare @retorno int " +
                "INSERT INTO [dbo].[BasketItems]([Amount], [ItemCount], [BookVariableInfoId], [BasketId], [PaymentId]) VALUES(" +
                ...
                "declare @retorno int " +
                "INSERT INTO [dbo].[Books]([Name], [Year], [PageCount], [ImageName], [Description], [LanguageId]) VALUES(" +
                ...
                "declare @retorno int " +
                "INSERT INTO [dbo].[BookTags]([Name], [BookTypeId]) VALUES(" +
                "(@Name), (@BookTypeId)) " +
                "select @retorno;");
                ...
                "declare @retorno int " +
                "INSERT INTO [dbo].[BookVariableInfoes]([Id], [ProductCount], [Price]) VALUES(" +
                ...
                "declare @retorno int " +
                "INSERT INTO [dbo].[Individuals]([Id], [LastName],[FirstName],[MiddleName]) VALUES( " +
                ...
                "declare @retorno int " +
                "INSERT INTO [dbo].[Languages]([Name]) VALUES(" +
                "(@Name)) " +
                "select @retorno;");
                ...
                "declare @retorno int " +
                "INSERT INTO [dbo].[Payments]([Id], [isPayed], [ShopId], [IndividualId]) VALUES( " +
                ...
                "declare @retorno int " +
                "INSERT INTO [dbo].[W1Payments]([WMI_MERCHANT_ID], [WMI_CURRENCY_ID], [WMI_DESCRIPTION], [WMI_EXPIRED_DATE], [WMI_PAYMENT_AMOUNT], [WMI_SIGNATURE]) VALUES( " +
                ...
                dbContext.Database.ExecuteSqlCommand(
                "CREATE PROCEDURE [dbo].[GetAllBooksByTagId] @TagId int AS  " +
                "SELECT * " +
                "FROM [dbo].[Books] " +
                "WHERE [dbo].[Books].[Id] = (" +
                "SELECT [Book_Id]" +
